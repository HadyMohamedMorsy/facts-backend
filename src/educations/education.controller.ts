  ...
  implements SelectOptions, RelationOptions
{
  ...
  public selectOptions(): Record<string, boolean> {
    return {
      ...
      thumbnail: true,
      courseFile: true,
      advisorContactLink: true,
      education_topics: true,
      createdAt: true,
      updatedAt: true,
    };
  }
    ...
    return await this.service.create(
      {
        ...
        advisorContactLink: create.advisorContactLink,
        education_topics: create.education_topics,
    ...
    return await this.service.update(
      {
        ...
        courseFile: update.courseFile,
        advisorContactLink: update.advisorContactLink,
        education_topics: update.education_topics,
